"""
Alembic env.py — wires the CadOwl ORM metadata to Alembic.

Supports both online (real DB) and offline (SQL-emitting) migration modes.
Reads DATABASE_URL from environment, falling back to the alembic.ini value.
